...
namespace Lesson6
{
    ...
    public class Passwords
    {
        public string[] GetPasswords()
        {
         ...
         passwordsArr[1] = "sergei | abs1 | Сергей Костюков";
         passwordsArr[2] = "sergei | abs2 | Сергей Костюков";
         passwordsArr[3] = "sergei | abs3 | Сергей Костюков";
         passwordsArr[4] = "sergei | abs4 | Сергей Костюков";
         passwordsArr[5] = "sergei | abs5 | Сергей Костюков";
         passwordsArr[6] = "sergei | abs6 | Сергей Костюков";
         passwordsArr[7] = "sergei | abs7 | Сергей Костюков";
         passwordsArr[8] = "sergei | abs8 | Сергей Костюков";
         passwordsArr[9] = "sergei | abs 9| Сергей Костюков";
         passwordsArr[10] = "ivan | 1234 | Иванов Иван";
         passwordsArr[11] = "ivan | 1235 | Иванов Иван";
         passwordsArr[12] = "ivan | 1236 | Иванов Иван";
         passwordsArr[13] = "ivan | 1237 | Иванов Иван";
         passwordsArr[14] = "ivan | 456 | Иванов Иван";
         passwordsArr[15] = "ivan | 465 | Иванов Иван";
         passwordsArr[16] = "ivan | 988 | Иванов Иван";
         passwordsArr[17] = "ivan | 555 | Иванов Иван";
         passwordsArr[18] = "ivan | 777 | Иванов Иван";
         passwordsArr[19] = "ivan | 546| Иванов Иван";
         return passwordsArr;
        }
    }
    ...
    public class User
    {
       ...
       {
       	Passwords p = new Passwords();
       	string[] Arr1 = p.GetPasswords();
       	for (int i = 0; i < Arr1.Length; i++)
       	{
       		if (Arr1[i].Split('|')[0].Trim() == Login && Arr1[i].Split('|')[1].Trim() == Password)
       		{
       			return Arr1[i].Split('|')[2].Trim();
       		}
       	}
       	return "";
       }
        ...
        public void Log()
        {
        	...
        	string Text = "";
        	Text += "========================Лог пользователя "+Name+"================================"+Environment.NewLine;
        	Text += Name;
